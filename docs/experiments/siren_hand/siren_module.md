...
|---|---|---|---|---|
| **mean_hand_conf ↑** | 0.6801 | 0.6988 | **0.7249** | **101/109**,p=6.4e-22 |
| hand_good_rate ↑ | 0.8831 | 0.8628 | **0.8939** | 坏手率降低 |
| FVD ↓ | 907.1 | 830.4 | 804.3 | 胜 |
| CSIM mean/worst/std | .773/.671/.039 | **.809**/.766/.0189 | .826/.785/**.0183** | 胜 |
| body_pck / body_nme | .274/.444 | .280/.414 | **.309/.416** | 略胜 |
| hand_pck / hand_nme | .326/.532 | .318/.533 | **.337/.566** | 胜 |
