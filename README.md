...
Downstream evaluations live under `docs/experiments/` and are interchangeable — e.g. a sign- and hand-fidelity stress test (`docs/experiments/baseline/sign_cmp_quantitative.md`) on ASL50K is one such experiment and can be swapped for other downstream datasets.
